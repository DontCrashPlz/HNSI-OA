package com.hnsi.oa.hnsi_oa.widgets.CustomTabLayout;
...
import static com.hnsi.oa.hnsi_oa.widgets.CustomTabLayout.Tool.getScreenWidth;
import static com.hnsi.oa.hnsi_oa.widgets.CustomTabLayout.Tool.getTextViewLength;
...
public class ViewPagerTitle extends HorizontalScrollView {
    ...
    private void createTextViews(String[] titles) {
        ...
        //添加underLine
        FrameLayout.LayoutParams underLineLp=
        ...
        //添加标题布局
        FrameLayout.LayoutParams textLayoutLp=
                new FrameLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT);
