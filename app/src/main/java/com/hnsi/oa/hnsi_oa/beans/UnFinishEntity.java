...
public class UnFinishEntity {
    ...
    private ArrayList<UnFinishedFlowEntity> taskList;
    ...
    public ArrayList<UnFinishedFlowEntity> getTaskList() {
        return taskList;
    }

    public void setTaskList(ArrayList<UnFinishedFlowEntity> taskList) {
